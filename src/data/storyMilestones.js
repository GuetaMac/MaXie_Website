// Shared "Our Story" milestone data.
//
// This used to live directly inside src/pages/OurStory.jsx. It's pulled out
// here so both the Our Story page AND the AI Chat page can import the same
// data without duplicating this text in two places.
